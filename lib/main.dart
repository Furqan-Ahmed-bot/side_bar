...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> sandwitches = [
    'CLUB SANDWICH',
    'BBQ CLUB SANDWICH',
    'FAJITA SANDWICH',
    'BBQ SUB SANDWICH',
    'TBEEF STEAK SANDWICH'
  ];
          ...
          ScrollableListTab(
              tab: ListTab(
                  label: Text(
                   ...
                   activeBackgroundColor:  Color(0xFFC4996C),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        const EdgeInsets.fromLTRB(0, 25, 40, 0),
                                    child: Container(
                                       decoration: BoxDecoration(
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(0, 45, 10, 0),
                                child: Container(
                                     decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(4),
